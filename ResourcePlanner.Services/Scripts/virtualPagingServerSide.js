    ...
    var dataSource = {
        ...
        getRows: function (params) {
            ...
            setTimeout(function () {
                ...
                var startDateParam = 'StartDateParam=2012-12-31';
                var endDateParam = 'EndDateParam=2012-12-31';

                var startRowParam = 'StartRowParam=' + params.startRow;
                var endRowParam = 'EndRowParam=' + params.endRow;

                filters += startDateParam + '&' + endDateParam;// + '&' + startRowParam + '&' + endRowParam;
